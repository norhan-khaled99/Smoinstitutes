      ...
      <q-card-section>
        ...
        <div class="row q-col-gutter-lg">
          <div class="col-12 col-md-6">
            <div class="form-group">
              ...
              <q-select v-model="form.level" :options="levelOptions" option-label="name" option-value="id" outlined
                dense emit-value map-options placeholder="Select Level" class="custom-select" />
            </div>
          </div>
          <div class="col-12 col-md-6">
            <div class="form-group">
              ...
              <q-select v-model="form.teacher" :options="teacherOptions" option-label="name" option-value="id" outlined
                dense emit-value map-options placeholder="Select Teacher" class="custom-select" />
            </div>
          </div>
          ...
          <div class="col-12 col-md-6">
            <div class="form-group">
              <label>Shift</label>
              <q-select v-model="form.shift" :options="shiftOptions" outlined dense placeholder="N/A"
                class="custom-select" />
            </div>
          </div>
        ...
        <div class="popup-actions">
          ...
          <q-btn v-if="!isEdit" label="Save & Add Another" class="btn-save-add" no-caps @click="save(false)" />
          <q-btn label="Save & Close" class="btn-save-close" no-caps @click="save(true)" />
        </div>
      </q-card-section>
    </q-card>
  </q-dialog>
