  ...
  <div class="add-edit-container">
    ...
    <div class="form-header">
      <div class="header-info">
        ...
        <p class="header-meta">
          ID : <span>{{ staffId }}</span> | Registration Date :
          <span>{{ registrationDate }}</span>
        </p>
      </div>
      <div class="header-actions">
        <q-btn-dropdown split label="Save Staff" class="save-btn-dropdown" @click="saveStaff" no-caps>
          <q-list>
            <q-item clickable v-close-popup @click="saveStaff">
        ...
        <q-btn flat label="Cancel" class="cancel-btn" @click="cancel" no-caps />
      </div>
    </div>
      ...
      <div class="form-section">
        ...
        <div class="media-upload">
          ...
          <div class="upload-info">
            <q-file v-model="photo" ref="fileInput" style="display: none" accept=".jpg, .png, .gif"
        ...
        <div class="row q-col-gutter-md">
                ...
                <template v-slot:append>
                  <div>
                    ...
                    <q-popup-proxy cover transition-show="scale" transition-hide="scale">
                      <q-date v-model="form.dateOfBirth" mask="DD/MM/YYYY">
          ...
          <div class="col-12 col-md-6">
            <div class="form-group">
              ...
              <q-input outlined v-model="form.email" type="email" placeholder="staff@example.com" dense />
            </div>
          </div>
          ...
          <div class="col-12 col-md-6">
            <div class="form-group">
              ...
              <q-input outlined v-model="form.nationalId" placeholder="0" dense />
            </div>
          </div>
          ...
          <div class="col-12 col-md-6">
            <div class="form-group">
              ...
              <q-input outlined v-model="form.phone" placeholder="+25713405" dense />
            </div>
          </div>
          ...
          <div class="col-12 col-md-6">
            <div class="form-group">
              <p class="field-label">Other Contact</p>
              <q-input outlined v-model="form.otherContact" placeholder="+971577254005" dense />
            </div>
          </div>
          ...
          <div class="col-12 col-md-3">
            <div class="form-group">
              ...
              <q-select outlined v-model="form.city" :options="cityOptions" :label="form.city == undefined || form.city == '' ? 'Select City' : ''
                " dense />
            </div>
          </div>
        ...
        <div class="row q-col-gutter-md">
          <div class="col-12 col-md-6">
            <div class="form-group">
              ...
              <q-input outlined v-model="form.job" placeholder="+971557134005" dense />
            </div>
          </div>
          <div class="col-12 col-md-6">
            <div class="form-group">
              <p class="field-label">Staff Job Type</p>
              <q-select outlined v-model="form.jobType" :options="jobTypeOptions" :label="form.jobType == undefined || form.jobType == ''
                  ? 'Select Job Type'
                  : ''
                " dense />
            </div>
          ...
          <div class="col-12 col-md-6">
            <div class="form-group">
              ...
              <q-input outlined v-model="form.dailySalary" placeholder="0" dense />
            </div>
          </div>
          <div class="col-12 col-md-6">
            <div class="form-group">
              <p class="field-label">Recent employment</p>
              <q-input outlined v-model="form.recentEmployment" placeholder="" dense />
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row q-col-gutter-md">
          <div class="col-12 col-md-4">
            <div class="form-group">
              ...
              <q-select outlined v-model="form.degree" :options="degreeOptions" :label="form.degree == undefined || form.degree == ''
                  ? 'Select Degree'
                  : ''
                " dense />
            </div>
          ...
          <div class="col-12 col-md-4">
            <div class="form-group">
              ...
              <q-input outlined v-model="form.yearOfGraduation" placeholder="0" dense />
            </div>
          </div>
          <div class="col-12 col-md-4">
            <div class="form-group">
              <p class="field-label">Institution</p>
              <q-select outlined v-model="form.institution" :options="institutionOptions" :label="form.institution == undefined || form.institution == ''
                  ? 'Select Institution'
                  : ''
                " dense />
            </div>
        ...
        <div class="row q-col-gutter-md">
          <div class="col-12 col-md-6">
            <div class="form-group documents-files">
              ...
              <q-file outlined v-model="form.idCardFile" dense label="No file chosen">
          ...
          <div class="col-12 col-md-6">
            <div class="form-group documents-files">
              ...
              <q-file outlined v-model="form.cvFile" dense label="No file chosen">
                <template v-slot:prepend>
                  <div class="file-prepend">Choose file</div>
                </template>
              </q-file>
...
const cityOptions = ref(["Dubai", "Abu Dhabi", "Sharjah", "Ajman"]);
const jobTypeOptions = ref(["Teaching staff", "Admin", "Support"]);
const degreeOptions = ref(["High School", "Bachelor", "Master", "PhD"]);
const institutionOptions = ref(["University A", "University B"]);
...
const saveStaff = () => {
  console.log("Saving staff", form.value);
  router.back();
};
