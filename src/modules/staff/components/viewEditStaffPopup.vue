    ...
    <q-card class="edit-view-card row no-wrap">
      ...
      <div class="sidebar col-auto">
        <div class="profile-section">
          <q-img
            v-if="staffData.picture && notChange"
            :src="picturePreview"
            class="profile-image"
          />
          ...
          <q-img
            v-if="staffData.picture && !notChange"
            :src="`https://test.caiaden.com${staffData.picture}`"
            class="profile-image"
          />

          <q-file
            v-if="isEditMode"
            v-model="staffData.picture"
            outlined
            dense
            label="Change Photo"
        ...
        <div class="tabs-section full-width">
          <div
            v-for="tab in tabs"
            :key="tab.id"
            class="tab-item row items-center no-wrap"
      ...
      <div class="main-content col">
        ...
        <div v-if="activeTab === 'basic'" class="popup-form-grid row">
          ...
          <div class="col-6">
            ...
            <div v-if="isEditMode" class="row q-col-gutter-xs">
              ...
              <div class="col-4">
                <q-input
                  outlined
                  v-model="staffData.middle_names"
                  dense
          ...
          <div class="col-6">
            ...
            <div
              v-if="isEditMode"
              class="row items-center q-gutter-x-sm h-input"
            >
              <q-radio
          ...
          <div class="col-6">
            ...
            <q-select
              v-if="isEditMode"
              outlined
              v-model="staffData.city"
              :options="cityOptions"
              :label="
                staffData.city == undefined || staffData.city == ''
                  ? 'Select City'
                  : ''
              "
              dense
        ...
        <div v-if="activeTab === 'job'" class="popup-form-grid row">
          ...
          <div class="col-6">
            ...
            <q-select
              ...
              v-model="staffData.staffjobtype"
              :options="jobTypeOptions"
              :label="
                staffData.staffjobtype == undefined ||
            ...
            />
            <div v-else class="field-value">
              {{ getJobTypeName(staffData.staffjobtype) }}
            </div>
          </div>
          ...
          <div class="col-6">
            ...
            <q-input
              v-if="isEditMode"
              outlined
              v-model="staffData.current_salary"
              dense
          ...
          <div class="col-6">
            ...
            <q-input
              v-if="isEditMode"
              outlined
              v-model="staffData.recent_employment"
              dense
        ...
        <div v-if="activeTab === 'education'" class="popup-form-grid row">
          ...
          <div class="col-6">
            ...
            <q-select
              ...
              option-label="name"
              option-value="id"
              v-model="staffData.degree"
              :options="degreeOptions"
              :label="
                staffData.degree == undefined || staffData.degree == ''
                  ? 'Select Degree'
                  : ''
              "
              dense
          ...
          <div class="col-6">
            ...
            <q-input
              v-if="isEditMode"
              outlined
              v-model="staffData.year_of_graduation"
              dense
          ...
          <div class="col-6">
            ...
            <q-select
              ...
              option-label="name"
              option-value="id"
              v-model="staffData.institution"
              :options="institutionOptions"
              :label="
                staffData.institution == undefined ||
        ...
        <div v-if="activeTab === 'documents'" class="popup-form-grid row">
          ...
          <div class="col-6">
            ...
            <div
              class="document-card row items-center no-wrap q-pa-sm"
              :class="{ 'has-file': staffData.id_card }"
              @click="isEditMode && $refs.idCardInput.click()"
            >
              <template
                v-if="
              ...
              >
                ...
                <div class="file-info col">
                  ...
                  <a
                    :href="`https://test.caiaden.com${staffData.id_card}`"
                    target="_blank"
                ...
                >
                  ...
                  >
                    ...
                    />
                    <path
                      d="M7.9165 9.16602L8.33317 13.3327"
                      stroke="#C81E1E"
                      stroke-width="1.5"
                      stroke-linecap="round"
                    />
                    <path
                      d="M12.0832 9.16602L11.6665 13.3327"
                      stroke="#C81E1E"
                      stroke-width="1.5"
                      stroke-linecap="round"
                    />
              ...
              <template v-else-if="isEditMode">
                <div
                  class="file-placeholder row items-center full-width cursor-pointer"
          ...
          <div class="col-6">
            ...
            <div
              class="document-card row items-center no-wrap q-pa-sm"
              :class="{ 'has-file': staffData.cv }"
              @click="isEditMode && $refs.cvInput.click()"
            >
              <template v-if="staffData.cv && typeof staffData.cv === 'string'">
                ...
                <div class="file-info col">
                  ...
                  <a
                    :href="`https://test.caiaden.com${staffData.cv}`"
                    target="_blank"
                    class="text-grey-6 text-caption"
                    style="text-decoration: none; cursor: pointer"
                  >
              ...
              <template
                v-else-if="staffData.cv && typeof staffData.cv === 'object'"
              >
                <div class="file-icon pdf q-mr-md">
                  <svg
                    width="26"
              ...
              <template v-else-if="isEditMode">
                ...
                <input
                  ...
                  ref="cvInput"
                  style="display: none"
                  @change="(e) => handleFileUpload(e, 'cv')"
                />
              </template>
            </div>
          </div>
...
const emit = defineEmits(["update:modelValue", "save", "staffAction"]);
...
// Emit update so parent `v-model` stays in sync and reset state when dialog opens/closes
watch(isOpen, (newVal) => {
...
const getTabTitle = () => {
  const prefix = isEditMode.value ? "Edit" : "View";
  switch (activeTab.value) {
    case "basic":
      return `${prefix} Basic Information`;
    case "job":
      return `${prefix} Job Information`;
    case "education":
    ...
    default:
      return `${prefix} Staff Information`;
  }
};
...
// return human-readable job type name for given id
const getJobTypeName = (id) => {
  if (id == undefined || id === "") return "";
  const job = jobTypeOptions.value.find((o) => o.jobstypeid == id);
  return job ? job.jobstypename : id;
};
