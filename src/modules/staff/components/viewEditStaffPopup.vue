      ...
      <div class="main-content col">
        ...
        <div v-if="activeTab === 'basic'" class="popup-form-grid row">
          ...
          <div class="col-6">
            ...
            <q-select
              ...
              :options="cityOptions"
              :label="
                staffData.city == undefined || staffData.city == '' ? 'Select City' : ''
              "
              dense
            />
        ...
        <div v-if="activeTab === 'job'" class="popup-form-grid row">
          ...
          <div class="col-6">
            ...
            <q-select
              ...
              :label="
                staffData.staffjobtype == undefined || staffData.staffjobtype == ''
        ...
        <div v-if="activeTab === 'education'" class="popup-form-grid row">
          ...
          <div class="col-6">
            ...
            <q-select
              ...
              :label="
                staffData.institution == undefined || staffData.institution == ''
                  ? 'Select Institution'
                  : ''
              "
              dense
        ...
        <div v-if="activeTab === 'documents'" class="popup-form-grid row">
          ...
          <div class="col-6">
            ...
            >
              <template v-if="staffData.id_card && typeof staffData.id_card === 'string'">
              ...
              <template v-else-if="staffData.id_card && typeof staffData.id_card === 'object'">
                <div class="file-icon pdf q-mr-md">
                  <svg
                    width="26"
                    height="26"
...
<script setup>
import { ref, defineEmits, watch, markRaw, h, onMounted } from "vue";
...
// Styles have been moved to src/css/popupDesign.scss
</style>
