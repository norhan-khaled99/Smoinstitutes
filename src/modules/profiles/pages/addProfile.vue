          ...
          >
            <q-list >
              ...
              <q-item
                clickable
                v-close-popup
                @click.prevent="saveProfile(false)"
              >
      ...
      <div class="form-content">
        ...
        <div class="form-section">
          ...
          <div class="row q-col-gutter-md">
            ...
            <div class="col-12 col-md-6">
              <div class="form-group">
                ...
                <q-select
                  ...
                  option-value="id"
                  :rules="rules.required"
                  v-model="form.mainacctype"
                  :options="accountTypeOptions"
                  :label="
                    form.mainacctype == undefined || form.mainacctype == ''
                      ? 'Select Main Account'
                      : ''
                  "
                  dense
            ...
            <div class="col-12 col-md-6">
              <div class="form-group">
                <p class="field-label">Other Contact 2</p>
                <q-input
                  outlined
...
const saveProfile = async (stayOrReturn) => {
