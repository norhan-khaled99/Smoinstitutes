  ...
  <div class="add-edit-container">
    ...
    <div class="form-header">
      <div class="header-info">
        <p class="header-title">Add New Profile</p>
        <p class="header-meta">
          ID : <span>{{ profileId }}</span> | Registration Date :
      ...
      <div class="header-actions">
        ...
        >
          <q-list style="min-width: 200px">
            <q-item clickable v-close-popup @click="saveProfile">
    ...
    <div class="form-content">
      ...
      <div class="form-section">
        ...
        <div class="row q-col-gutter-md">
          ...
          <div class="col-12 col-md-6">
            <div class="form-group">
              <p class="field-label">Main Account</p>
              <q-select
                outlined
                v-model="form.mainAccount"
                :options="mainAccountOptions"
                :label="
                  form.mainAccount == undefined || form.mainAccount == ''
                    ? 'Select Main Account'
                    : ''
                "
                dense
...
const form = ref({
  ...
  gender: "Male",
  dateOfBirth: "",
  mainAccount: "", // Changed from email
  nationalId: "",
  mobile: "",
  phone: "",
  otherContact: "",
...
const mainAccountOptions = ref(["Cash Box", "Bank", "Other"]); // Dummy options
