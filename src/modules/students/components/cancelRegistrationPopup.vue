<template>
  <q-dialog v-model="model" persistent>
    <q-card class="custom-popup" style="max-width: 400px">
      <q-card-section>
        <div class="popup-header">
          <p class="popup-title">Cancel Course Registration</p>
        ...
        <div class="form-group q-mb-md">
          ...
          <p class="field-value">{{ courseName.course_name }}</p>
        </div>
...
const confirmDelete = () => {
  emit("confirm", {
    ...cancellationData,
    regid: props.courseName.regid,
    course_id: props.courseName.course_id,
  });
  model.value = false;
};
</script>
